...
public class RapTAT extends JFrame {
  ...
  public void setBackgroundImage(String str) {
    ...
    try {
      ...
      InputStream imageStream = this.getClass().getResourceAsStream(Constants.MAIN_WINDOW_IMAGE);
  ...
  private void buildApplicationWindow() {
    setBackgroundImage(Constants.MAIN_WINDOW_IMAGE);
  ...
  private JEditorPane buildEditorPane() {
    ...
    try {
      InputStream helpFileInputStream =
          this.getClass().getResourceAsStream(Constants.MAIN_HELP_FILE);
      ...
      System.err.println(
          "Unable to load help page:" + Constants.MAIN_HELP_FILE + " " + e.getLocalizedMessage());
      e.printStackTrace();
    }
  ...
  private GridBagConstraints getScrollPanelConstraints() {
    ...
    theConstraints.insets =
        new Insets(Constants.INSET, 3 * Constants.INSET, Constants.INSET, Constants.INSET);
