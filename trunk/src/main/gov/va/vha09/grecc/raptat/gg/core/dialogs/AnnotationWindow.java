...
public class AnnotationWindow extends JDialog {
  ...
  private class AnnotateButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      double threshold = Constants.SEQUENCE_PROBABILITY_THRESHOLD_DEFAULT;
      ...
      try {
        ...
        AnnotationWindow.this.thresholdField
            .setText(Double.toString(Constants.SEQUENCE_PROBABILITY_THRESHOLD_DEFAULT));
      }
      if (thresholdInRange) {
...
/* Dax had code to assign an exportAnnotationGroupParameter here via
              ExportAnnonationGroupParameter exportAnnonationGroupParameter =
                  ExportAnnonationGroupParameter.init(curAnnotationGroup, curTextPath);
                  but the exportAnnotationGroupParameter seemed to be unused.
*/
  ...
  private final double threshold = Constants.SEQUENCE_PROBABILITY_THRESHOLD_DEFAULT;
  ...
  private void initialize(Point thePosition, Dimension theDimension) {
    ...
    windowWidth = windowWidth < Constants.TRAIN_WINDOW_MIN_WIDTH ? Constants.TRAIN_WINDOW_MIN_WIDTH
        : windowWidth;
    windowHeight =
        windowHeight < Constants.ANNOTATE_WINDOW_MIN_HEIGHT ? Constants.ANNOTATE_WINDOW_MIN_HEIGHT
            : windowHeight;
