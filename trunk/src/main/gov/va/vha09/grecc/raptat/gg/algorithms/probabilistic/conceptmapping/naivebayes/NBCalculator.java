...
public class NBCalculator extends ConceptMapCalculator {
  ...
  /****************************************************************
   * calcBestConcept - Calculates the best concept to match a particular phrase
   *
   * @param theAttributes
   ...
   ****************************************************************/
  @Override
  public String[] calcBestConcept(String[] tokenStrings, Set<String> acceptableConcepts) {
  ...
  /****************************************************************
   * bestConceptSmoothed - Determine best concept (maximal valued concept) for the set of token
   * strings provided using standard LaPlace smoothing.
   *
   *
   * @param tokenStrings
