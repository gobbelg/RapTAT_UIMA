...
/********************************************************
 * Used by the NBSequenceIDTrainer (and NTTokenSequenceEvaluator) to store the likelihood of a token
 * at a particular position in a phrase of being classified as unannotated (position 0 in the list)
 * or annotated (position 1 in the list).
 *
