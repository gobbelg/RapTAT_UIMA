...
/********************************************************
 * Maintains and reads from disk a list of UnlabeledHashTrees.
 *
 *
...
public class UnlabeledHashTreeInputStream implements HashTreeInStreamer<UnlabeledHashTree> {
  ...
  /****************************************************
   * Creates a new UnlabeledHashTreeInputStream with the UnlabeledHashTrees populated from the file
   * given as fileName.
   *
   * @param fileName
   ****************************************************/
