...
public class GarvinCreateVersion2 {
  ...
  // @formatter:off
	...
	{
		DOCUMENT, SENTENCE, OVERT_RNM, NONOVERT_RNM, BETABLOCKER_POSITIVE, BETABLOCKER_NEGATIVE, CAUSALCUE,
		BP, BR, COMPLIANCE, DRUG, EX, FLUID, HB, HF, HR, NPO, RHYTHM, VESTIBULAR,
		VISION, BETABLOCKER_POSITIVE_AND_OVERT_RNM, BETABLOCKER_NEGATIVE_AND_OVERT_RNM, CAUSALCUE_AND_OVERT_RNM,
		BP_AND_OVERT_RNM, BR_AND_OVERT_RNM, COMPLIANCE_AND_OVERT_RNM, DRUG_AND_OVERT_RNM,
		EX_AND_OVERT_RNM, FLUID_AND_OVERT_RNM, HB_AND_OVERT_RNM, HF_AND_OVERT_RNM,
		HR_AND_OVERT_RNM, NPO_AND_OVERT_RNM, RHYTHM_AND_OVERT_RNM, VESTIBULAR_AND_OVERT_RNM,
		VISION_AND_OVERT_RNM, BETABLOCKER_POSITIVE_AND_NONOVERT_RNM, BETABLOCKER_NEGATIVE_AND_NONOVERT_RNM,
		CAUSALCUE_AND_NONOVERT_RNM, BP_AND_NONOVERT_RNM, BR_AND_NONOVERT_RNM,
		COMPLIANCE_AND_NONOVERT_RNM, DRUG_AND_NONOVERT_RNM, EX_AND_NONOVERT_RNM,
		FLUID_AND_NONOVERT_RNM, HB_AND_NONOVERT_RNM, HF_AND_NONOVERT_RNM,
		HR_AND_NONOVERT_RNM, NPO_AND_NONOVERT_RNM, RHYTHM_AND_NONOVERT_RNM,
		VESTIBULAR_AND_NONOVERT_RNM, VISION_AND_NONOVERT_RNM
	}

	// @formatter:off
	private enum ReportIndexFine
	{
		DOCUMENT, SENTENCE, NONOVERT_RNM, OVERT_RNM, BETABLOCKER_POSITIVE, BETABLOCKER_NEGATIVE, CAUSALCUE,
		BP, BR, COMPLIANCE, DRUG, EX, FLUID, HB, HF, HR, NPO, RHYTHM, TOLERANCE, VESTIBULAR,
		VISION
	}
	// @formatter:on
        ...
        for (RaptatPair<File, File> curTraining : trainingFiles) {
          ...
          if (analysisFine) {
            ...
            for (RaptatPair<String, List<RaptatPair<Integer, Integer>>> sentenceIndexPair : indexValues) {
              ...
              documentStatistics.put(doc.getTextSourceName() + "\t" + sentencePhrase,
            ...
            documentStatistics.put(doc.getTextSourceName().get(), indexValues);
          }
        }
