...
public class BOWConceptMapCalculator extends NBCalculator {
  ...
  /****************************************************************
   * calcBestConcept - Calculates the best concept to match a particular phrase. Note that concept
   * matching using bag of words is really only set up to or works with smoothing. Without
   * smoothing, the calculations can be quite long because there can be cases for which the number
   * of occurrences of a concept and the number of times an attribute is associated with the concept
   * are equal. For such a case, the log becomes -Infinity, so we have to work around this
   * possibility.
   *
   * @param theAttributes
   ...
   ****************************************************************/
  @Override
  public String[] calcBestConcept(String[] theAttributes, Set<String> acceptableConcepts) {
  ...
  /****************************************************************
   * Determine best concept (maximal valued concept) for the set of attributes provided using a
   * modified smoothing method where only the numerator has values added to account for attributes
  ...
  private String bestConceptMod(String[] attributes, Enumeration<String> testConcepts) {
    String curMaxConcept = Constants.NULL_ELEMENT;
  ...
  /****************************************************************
   * bestConceptNoSmooth - Find the best concept for a set of attributes using no smoothing to
   * account of zero occurrences. This should only be called if the set of attributes all match to
   * at least
   *
   * @param attributes
   * @param testConcepts
  ...
  /****************************************************************
   * bestConceptSmoothed - Determine best concept (maximal valued concept) for the set of attributes
   * provided using standard LaPlace smoothing.
   *
   *
   * @param attributes
  ...
  /****************************************************************
   * For each attribute, find the associated, potential concepts and put them into a table
   *
  ...
  private Hashtable<String, Boolean> getPotentialConcepts(String[] attributes,
      Set<String> acceptableConcepts, boolean smoothing) {
  ...
  /****************************************************************
   * Recursive method to determine if all conditional tables within an array have a particular item
   * as a key.
   *
   * @param attributes
