...
/********************************************************
 * Implements both HashTreeInStreamer and HashTreeOutStreamer interfaces so that a class can use
 * UnlabeledHashTrees stored in either memory (as are instances of this class) or on disk (see
 * UnlabeledHashTreeOutputStream and UnlabeledHashTreeInputStream) using a common interface.
 *
...
public class UnlabeledHashTreeStreamer
  ...
  /**********************************************
   * Reads in one or a series of UnlabeledHashTree instances from a file and stores them in the
   * List, theTreeList.
   *
