...
public class CVParser {
   ...
   */
  private final static String TRAINING_GROUP_SIZE_SHORTOPT = "u";

  private final static String TRAINING_GROUP_SIZE_LONGOPT = "trainingGroupSize";
   ...
   * list and is ignored.
   */
  private final static String SCORING_CONCEPTS_FILEPATH_SHORTOPT = "l";

  private final static String SCORING_CONCEPTS_FILEPATH_LONGOPT = "scoringConceptsFilePath";
   ...
   */
  private final static String START_INDEX_SHORTOPT = "x";
  private final static String START_INDEX_LONGOPT = "startIndex";
  private final static String STOP_INDEX_SHORTOPT = "j";
  private final static String STOP_INDEX_LONGOPT = "stopIndex";
