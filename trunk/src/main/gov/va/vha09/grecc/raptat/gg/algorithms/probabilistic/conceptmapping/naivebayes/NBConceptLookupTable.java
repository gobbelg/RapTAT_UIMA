...
/************************************************************
 * NBConceptLookupTable - Used by ConditionalTable for creating essentially a two-dimensional
 * hashtable (hash into a 2nd hash). This hash takes a string which keys into an OccurProbTriplet
 * containing the number of occurrences and likelihoods for the concept, which is provided in the
 * form of a string representing the concept.
 *
...
public class NBConceptLookupTable extends Hashtable<String, OccurProbTriplet>
  ...
  /*****************************************************************
   * Construct a Naive Bayes (NB) ConceptLookupTable with an initial capacity
   *
   * @param startCapacity
   *****************************************************************/
