...
/********************************************************
 * A type of LabeledHashTree in which, whenever a token sequence is added to the tree, only the last
 * token in the sequence has its labeled value incremented by one.
 *
...
public class UnsmoothedLabeledTree extends LabeledHashTree {
   ...
   * addLabeledPhrase(List<Token>). Unlike the superclass LabeledHashTree method, this method only
   * labels the very last token in a sequence.
   *
