...
/************************************************************
 * NBResultWriter - Class to create a file to write the results from a test of a naive Bayes
 * network. It generates a file to write to at construction, writes a new line of text when given a
 * String array, and closes the file when prompted
 *
