...
/************************************************************
 * Holds the occurrences of a concept with a given word, the number of occurrences when smoothing is
 * used, and the likelihood associated with these smoothed values. Note that no likelihood are
 * supplied with the raw occurrence values because they are not needed for calculation of
 * likelihood.
 *
...
public class NonNBOccurProbSet {
  ...
  /************************************************************
   * Increment rawOccurrences and smoothOccurrences but do not update the calculated value of
   * smoothProbability
   ************************************************************/
