 ...
 * @author gtony
 *
 *         Here is an example that optimises three parameters of LinearRegression: a Boolean option,
 *         a three-valued option, and a numeric parameter. weka.classifiers.meta.MultiSearch -E CC
 *         -search "weka.core.setupgenerator.ListParameter -property attributeSelectionMethod
 *         -custom-delimiter , -list \"No attribute selection,M5 method,Greedy method\"" -search
 *         "weka.core.setupgenerator.MathParameter -property ridge -min -5.0 -max 5.0 -step 1.0
 *         -base 10.0 -expression pow(BASE,I)" -search "weka.core.setupgenerator.ListParameter
 *         -property eliminateColinearAttributes -list \"false true\"" -class-label 1 -algorithm
 *         "weka.classifiers.meta.multisearch.DefaultSearch -sample-size 100.0 -initial-folds 2
 *         -subsequent-folds 10 -initial-test-set . -subsequent-test-set . -num-slots 1" -log-file
 *         /Users/eibe -S 1 -W weka.classifiers.functions.LinearRegression -output-debug-info -- -S
 *         0 -C -R 1.0 -num-decimal-places 4 Make sure that you include -output-debug-info to check
 *         that all parameters you specified are actually modified! MultiSearch silently ignores
...
public class WekaRunner {
  ...
  public static void main(String[] args) {
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      /**
       * This is an example method for showing how the multiclass package can be called from a java
       * method and run to determine the best hyperparameters for a J48 decision tree
       *
       */
      private void testMultiSearchAppRun() {
        ...
        parameterList.add("-search");
        parameterList
            .add("weka.core.setupgenerator.ListParameter -property minNumObj -list \"0 1 2 3 4\"");
        parameterList.add("-search");
        parameterList
            .add("weka.core.setupgenerator.ListParameter -property unpruned -list \"true false\"");
        parameterList.add("-t");
      ...
      private void testMultiSearchHelp() {
        ...
        parameterList.add("\"C:/Program Files/Java/jdk1.8.0_191/bin/java\"");
        parameterList.add("-Xmx2048m");
        parameterList.add("-classpath");

        // Change next line as needed to point to weka.jar file
        parameterList.add("\"%CLASSPATH%;C:/Program Files/Weka-3-8/weka.jar\"");
      ...
      private void testMultiSearchRun() {
        ...
        // Change next line as needed to point to data for analysis
        parameterList.add("C:/Users/gtony/OneDrive/Documents/wekaData/iris.arff");
        parameterList.add("-class-label");
        parameterList.add("1");
        parameterList.add("-algorithm");
        parameterList.add(
