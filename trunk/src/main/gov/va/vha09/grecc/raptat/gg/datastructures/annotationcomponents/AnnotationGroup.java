...
public class AnnotationGroup implements Serializable {
  ...
  public void printBaseAnnotations() {
    String docPath = this.raptatDocument.getTextSourcePath().orElse("NoTextSourcePath");
  ...
  /*************************************************************
   * Replace phrases that have been split during processing because they were longer than the
   * maximum number of tokens allowed for training with the original phrases.
   *
