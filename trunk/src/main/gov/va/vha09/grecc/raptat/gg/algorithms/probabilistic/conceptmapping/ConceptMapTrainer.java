...
/**************************************************************
 * Interface to assure that all trainers of machine learning systems contain a getSolution method.
 *
...
public abstract class ConceptMapTrainer {
  ...
  protected int maxElements = Constants.MAX_TOKENS_DEFAULT; // maximum number of tokens
