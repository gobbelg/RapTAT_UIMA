...
/************************************************************
 * StringPair - Object to hold a pair of strings
 *
...
public class StrPair {
  ...
  /*****************************************************************
   * Construct a StringPair from two String objects
   *
   * @param first
   * @param second
   *****************************************************************/
  ...
  /****************************************************************
   * Determines whether an object is equal to this one. If the objects point to the same location,
   * are of the same class, and contain the same strings, it returns true.
   *
  ...
  /****************************************************************
   * Calculates the hash of the pair during construction of the object to speed later evaluation of
