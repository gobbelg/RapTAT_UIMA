...
/************************************************************
 * ConditionalTree - Stores conditional likelihood for given word phrase combinations
 *
...
public class ConditionalTree extends Hashtable<String, ConditionalTree> {
  ...
  /****************************************************************
   * Gets the last ConceptLookUpTable referred to by a phrase
   *
  ...
  /****************************************************************
   * Gets the last ConditionalTree referred to by a phrase
   *
   * @param phrase - String array holding the attributes of the phrase
  ...
  /****************************************************************
   * Increment the occurrences in the ConceptLookupTables associated with the current phrase and
   * concept.
   *
  ...
  public boolean increment(String[] inPhrase, String curConcept) {
    ...
    if (!containsKey(inPhrase[0])) {
      uniquePhrase = true;
      curTree = new ConditionalTree(subPhrase, Constants.NNB_COND_TREE_SIZES,
          Constants.NNB_CONCEPTS_PER_ATTRIBUTE);
