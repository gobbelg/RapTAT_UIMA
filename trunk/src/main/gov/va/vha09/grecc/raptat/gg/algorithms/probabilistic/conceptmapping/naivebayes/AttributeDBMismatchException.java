...
/************************************************************
 * AttributeDBMismatchException - Allows us to specify a particular type of exception when the
 * number of attributes fed into a NaiveBayesCalculator does not match the number expected based on
 * the training data.
 *
