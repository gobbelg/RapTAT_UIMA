...
/********************************************************
 * Keeps track of how many phrases are annotated or not annotated, and, based on those numbers,
 * computes the contribution to likelihood when a phrase under consideration has various lengths and
 * various numbers of upstream and downstream tokens for consideration. Prior probability is based
 * entirely on phrase length, number of upstream, and number of downstream tokens and how often, in
 * the training set, a phrase with similar characteristics (length, upstream and downstream tokens)
 * was annotated.
 *
