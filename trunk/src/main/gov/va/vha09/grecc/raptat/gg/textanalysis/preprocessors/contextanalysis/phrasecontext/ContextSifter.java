...
/**************************************************
 * Removes phrases that do not have the proper context. Note that any item in the requiredContexts
 * field must not be in the forbiddenContexts field to be logically consistent. These logical
 * consistencies are enforced by this class.
 *
