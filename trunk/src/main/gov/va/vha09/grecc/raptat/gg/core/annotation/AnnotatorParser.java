...
public class AnnotatorParser {
  ...
  public AnnotatorParser() {
    ...
    Option exportOption = Option.builder("e").required(true).hasArg(true).longOpt("exportDir").desc(
        ...
        .build();
    Option conceptsFile =
        Option.builder("o").required(false).hasArg(true).longOpt("outputConceptsFilePath")
  ...
  public AnnotatorParameterObject parseCommandLine(String[] args) {
    ...
    String outputConceptsPath = null;
    ...
    try {
      ...
      if (cmd.hasOption('o') || cmd.hasOption("outputConceptsFilePath")) {
        outputConceptsPath = cmd.getOptionValue('o');
      }
    ...
    AnnotatorParameterObject annotationParameters = new AnnotatorParameterObject(solutionFilePath,
        textDirectoryPath, isBatch, exportDirectoryPath, outputConceptsPath, annotationApp);
