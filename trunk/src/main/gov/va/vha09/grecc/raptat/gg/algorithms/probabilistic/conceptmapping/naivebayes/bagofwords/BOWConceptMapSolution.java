...
public class BOWConceptMapSolution extends NBSolution {
  ...
  public BOWConceptMapSolution(int conceptPosition, boolean useNulls, boolean useStems,
    ...
    this.conditionals[0] = new BOWConditionalTable(Constants.NB_UNIQUE_TOKEN_TABLE_SIZE);

    this.vocabSize = new int[1];
    this.vocabSize[0] = 0;

    this.priors = new BOWPriorTable(Constants.NB_CONCEPT_TABLE_SIZE, conceptPosition);
  ...
  /*********************************************************************
   * Update the number of occurrences of a given word in the database
   *
