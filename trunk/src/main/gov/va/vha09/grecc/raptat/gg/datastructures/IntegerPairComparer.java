...
/********************************************************
 * This is similar to the ComparatorBinaryTree. This class allows for explicit storage of only
 * IntegerPair instances. Unlike ComparatorBinaryTree instances, this one allows searching with
 * Integers and comparison to the left side of the pair for the lookup() and
 * getClosestLesserOrEqualObject() methods.
 *
...
public class IntegerPairComparer {
  ...
  /*************************************************************
   * Create an empty searchable binary tree with null as the root node. The list can be sorted
   * during construction if this is selected by the user. Use of a sorted list will
   *
