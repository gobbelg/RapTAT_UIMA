...
/************************************************************
 * MultiFileFilter - allows the creation of a file filter for the open file dialogue so that any
 * combination of file types can be used
 *
...
public class MultiFileFilter extends FileFilter {
  ...
  /************************************************************
   * MultiFileFilter - Constructor for file filter
   *
   * @author Glenn Gobbel, Jan 30, 2011
   *
