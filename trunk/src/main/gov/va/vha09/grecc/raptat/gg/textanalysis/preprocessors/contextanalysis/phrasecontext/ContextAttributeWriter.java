...
/**************************************************
 * Determines the context for a phrase that is being annotated such as whether the phrase is
 * negated. This class keeps a list of context analyzers so multiple contexts can be analyzed. Note
 * that only one of a given type of context analyzer can exist in the list.
 *
