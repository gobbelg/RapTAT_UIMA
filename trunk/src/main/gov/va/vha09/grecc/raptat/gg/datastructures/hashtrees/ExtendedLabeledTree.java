...
/**********************************************
 * A type of LabeledHashTree for which, whenever sequences are added, all tokens in the sequence
 * have their "labeled" value within the tree incremented by one.
 *
...
public class ExtendedLabeledTree extends LabeledHashTree {
   ...
   * addLabeledPhrase(List<Token>). Unlike the superclass LabeledHashTree method, this method labels
   * everything up to the last token in a sequence equally, every time it is called, whereas, for
   * the superclass, it is only labeled equally when the sequence is first put into the structure.
   *
