...
/************************************************************
 * LabeledHashTree - Stores number of times a sequence of tokens was labeled or unlabeled in a
 * document as well as number of times a label was deleted by a reviewer following automated
 * annotation. Also keeps track of the likelihood of a particular sequence being labeled, which is
 * calculated when updateProbabilities() is called.
 *
...
public class LabeledHashTree extends HashTree<LabeledHashTree>
  ...
  /*************************************************************
   * Increments the deleted count of the input phrase
   *
  ...
  /****************************************************************
   * Increment the deleted occurrences for each token in a token sequence
   *
  ...
  /*************************************************************
   * Adds the token string or string stems of the current phrase to this tree. Precondition: Tokens
   * in the input phrase are in the exact order that they exist within the list that constitutes the
   * inputSequence. Also, there must be at least one token in the input phrase or the called
  ...
  /****************************************************************
   * Add the sequence to the LabeledHashTree and increment the labeled occurrences for last token in
   * a token sequence Precondition: inSequence is not empty
   *
   * @param inSequence - String array containing attributes to be incremented
   * @return - Boolean indicating if the phrase is unique
   ****************************************************************/
  ...
  /*************************************************************
   * Add a list of tokens to the labeled tree and mark the sequence as labeled if it's position is
   * greater than or equal to the value of index
   *
   * @param theSequence
   * @param index
   *
  ...
  /****************************************************************
   * Increment the unlabeled occurrences for a token sequence
   *
   * Precondition: inSequence is not empty
   *
   * @param inSequence - String array containing attributes to be incremented
  ...
  /****************************************************************
   * Increment the unlabeled occurrences for the last token in the token sequence. Returns 0 if the
   * sequence does not exist in the tree.
   *
   * Precondition: inSequence is not empty
   *
  ...
  /****************************************************************
   * Increment the unlabeled occurrences for the last token in the token sequence. Returns 0 if the
   * sequence does not exist in the tree. Precondition: inSequence is not empty and exists in the
   * tree. Postcondition: unlabeledOccurrences of the sequence are incremented by incrementValue
   *
   * @param inSequence
  ...
  /*************************************************************
   * Determines whether the likelihood in the current tree and all subtrees have been updated.
   *
   * @return boolean
   *
   * @author Glenn Gobbel - Feb 8, 2012
  ...
  /*************************************************************
   * Update the values of p_labeled, the likelihood of a sequence of tokens being labeled, for the
   * entire tree. This will reset probabilitiesUpdated to true;
   *
  ...
  /*************************************************************
   * Adds the token string or string stems of the current phrase to this tree. Helper method for
   * addLabeledPhrase(List<Token>).
   *
  ...
  /*************************************************************
   * Method to generate a random LabeledHashTree instance for testing purposes. The number of
   * phrases in the tree will be @param width
   *
   * @param depth
   * @return
   *
