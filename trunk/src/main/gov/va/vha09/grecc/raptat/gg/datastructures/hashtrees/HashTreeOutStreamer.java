...
/********************************************************
 * Provides common interface for appending another HashTree instance onto an existing group of one
 * or more HashTrees (that can be subsequently accessed via a HashTreeInStreamer instance
 *
