...
public final class ConceptMapTrainOptionsWindow extends JDialog implements ActionListener {
  ...
  protected ConceptMapTrainOptionsWindow(Point position, Dimension dim) {
    ...
    windowWidth =
        windowWidth < Constants.TRAIN_OPTIONS_MIN_WIDTH ? Constants.TRAIN_OPTIONS_MIN_WIDTH
            : windowWidth;
    windowHeight =
        windowHeight < Constants.TRAIN_OPTIONS_MIN_HEIGHT ? Constants.TRAIN_OPTIONS_MIN_HEIGHT
            : windowHeight;
  ...
  /****************************************************************
   * Builds a panel to determine what context usage during training
   *
   * @return JPanel
   ****************************************************************/
  private JPanel buildContextMethodPanel(JComboBox theContextMethods,
    ...
    for (String curMethod : Constants.CONTEXT_METHODS) {
  ...
  /****************************************************************
   * Builds a panel to determine what learning method to use for training the model
   *
   * @return JPanel
   ****************************************************************/
  private JPanel buildLMSelectionPanel() {
    ...
    for (String curMethod : Constants.CONCEPT_MAPPING_METHODS) {
  ...
  /****************************************************************
   * Create JPanel to save the settings for the training options
   *
   * @return Component
   ****************************************************************/
