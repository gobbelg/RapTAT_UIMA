...
/********************************************************
 * Class to store sequences of tokens in an efficient manner as a tree structure. The iterator can
 * be used to return the sequences in the instance. Note that iteration return the sequence as the
 * left side of a pair returned by the iterator. The LabeledHashTree instance on the right is a
 * dummy variable used only to make this class conform to the interface IterableHashTree.
 *
