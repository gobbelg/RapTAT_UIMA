...
public class NBPriorTable extends HashMap<String, OccurProbGroup> implements Serializable {
  ...
  /************************************************************
   * Calculate the likelihood based on the occurrences within the table
   *
  ...
  /****************************************************************
   * Calculate values for calculating likelihood based on concepts that have been modified since the
   * last calculation
   *
  ...
  /****************************************************************
   * Adds one to the integer within the pair hashed by aKey
   *
