...
public abstract class ResultWriter {
  ...
  public ResultWriter(String fileDirectoryName, String titleAppend, String[] resultTitles) {
    this.fileTitle = fileDirectoryName + "Res" + titleAppend + "_"
  ...
  public ResultWriter(String fileDirectoryName, String titleAppend, String[] resultTitles,
    ...
    this.fileTitle =
        fileDirectoryName + File.separator + "RapTAT_Res_" + titleAppend + "_" + GeneralHelper.getTimeStamp();
  ...
  /*****************************************************************
   * ResultWriter - Class to create a file to write the results from a test of a naive Bayes
   * network. It generates a file to write to at construction, writes a new line of text when given
   * a String array, and closes the file when prompted
   *
   * @author Glenn Gobbel, July 19, 2010
   *
   * @param fileDirectory
  ...
  public ResultWriter(String fileDirectory, String[] resultTitles, String inputDelimiter) {
    ...
    this.fileTitle = fileDirectory + File.separator + "RapTAT_Res_" + GeneralHelper.getTimeStamp();
  ...
  /*****************************************************************
   * Construct an object that can be used to write results of machine learning evaluation or
   * analysis
   *
   * @param resultTitles
   *****************************************************************/
  ...
  /****************************************************************
   * Write data in String [] to the file specified within the out field of the BayesResultWriter
   * object class
   *
  ...
  /****************************************************************
   * Write a line of data to the file specified within the out field of the BayesResultWriter object
   * class
   *
   * @param curData Data to be written
   ****************************************************************/
