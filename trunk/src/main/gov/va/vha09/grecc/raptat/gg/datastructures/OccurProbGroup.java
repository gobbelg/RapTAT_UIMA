...
/************************************************************
 * OccProbGroup - Object to hold an int and two double arrays in a single object. Used to store the
 * number of occurrences of an attribute and the conditional likelihood calculation values when the
 * data is unsmoothed and smoothed (to account for non-occurrences in the training data)
 *
...
public class OccurProbGroup implements Serializable {
   ...
   */
  public HashMap<String, Integer> mappedTokens = new HashMap<>(Constants.ATTRIBUTES_PER_CONCEPT);
  ...
  /*****************************************************************
   * Construct a IntDbl Pair from an Integer and Double object
   *
   * @param inInt
   * @param second
   *****************************************************************/
