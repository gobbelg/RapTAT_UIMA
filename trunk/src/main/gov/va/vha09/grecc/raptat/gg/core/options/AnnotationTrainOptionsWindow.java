...
public final class AnnotationTrainOptionsWindow extends JDialog implements ActionListener {
  ...
  private JPanel buildTrainingSelectionPane(JComboBox theTrainingMethods,
    ...
    for (String curMethod : Constants.PHRASE_ID_TRAINING_METHODS) {
  ...
  private void saveTrainOptions() {
    ...
    try {
      ...
      GeneralHelper
          .errorWriter("Token number reset to " + Constants.PHRASE_ID_SURROUNDING_TOKENS_DEFAULT);
      this.theOptions.annotationSurroundingTokens = Constants.PHRASE_ID_SURROUNDING_TOKENS_DEFAULT;
    }
  }
