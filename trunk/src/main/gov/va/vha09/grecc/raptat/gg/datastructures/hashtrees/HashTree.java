...
public abstract class HashTree<V extends HashTree> extends Hashtable<String, V>
  ...
  public HashTree() {
    super(Constants.LABELED_HASH_TREE_SIZE_DEPTH_0_DEFAULT);
    this.treeDepth = 0;
  }
  ...
  /*************************************************************
   * Determine the size of the next subtree based on the depth of this tree and default settings
   *
   * @return treeSize
   *
  ...
  protected int getNextTreeSize() {
    ...
    switch (this.treeDepth) {
      case 0:
        treeSize = Constants.LABELED_HASH_TREE_SIZE_DEPTH_1_DEFAULT;
        break;
      case 1:
        treeSize = Constants.LABELED_HASH_TREE_SIZE_DEPTH_2_DEFAULT;
        break;
      default:
        treeSize = Constants.LABELED_HASH_TREE_SIZE_DEPTH_OVER2_DEFAULT;
        break;
    }
    return treeSize;
  }
