...
/********************************************************
 * Gives an ordering to AnnotatedPhrase objects based first on length and then the likelihood, where
 * the AnnotatedPhrase objects come as pairs with the left part of the pair have the object itself
 * and the right containing the likelihood.
 *
