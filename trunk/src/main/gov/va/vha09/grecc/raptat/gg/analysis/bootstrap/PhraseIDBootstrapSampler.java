...
public class PhraseIDBootstrapSampler {
  ...
  /**********************************************
   * Default, no argument constructor created only for use by subclasses
   *
  ...
  /*************************************************************
   * Create a hash in which the first element hashes to the a string array containing full paths to
   * the text document and the xml file
   *
   * @param theElements
   *
