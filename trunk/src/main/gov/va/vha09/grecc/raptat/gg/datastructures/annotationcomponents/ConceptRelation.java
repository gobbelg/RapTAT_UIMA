...
public class ConceptRelation implements Comparable<Object>, Serializable {
   ...
   */
  public ConceptRelation(ConceptRelation conceptRelation) {
   ...
   */
  public ConceptRelation(ConceptRelationFields relationFields) {
    this.conceptRelationID = relationFields.conceptRelationID;
    this.conceptRelationName = relationFields.conceptRelationName;
    this.idOfRelatedAnnotation = relationFields.idOfRelatedAnnotation;
  }
   ...
   */
  public ConceptRelation(String conceptRelationID, String relationName, String id,
  ...
  /**
   * Returns the list of annotations in the relation
   *
  ...
  public void setConceptRelationName(String conceptRelationName) {
    this.conceptRelationName = conceptRelationName;
  }


  public void setRelatedAnnotationID(String idOfRelatedAnnotation) {
  ...
  public static String toStringForDisplay(ConceptRelation relation,
      Set<String> sentenceAssociatedPhrases, int minRelated) {
    if (relation == null) {
