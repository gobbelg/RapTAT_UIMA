...
/********************************************************
 * Allow reading in a file containing a series of the same object via iteration. The file must have
 * been written using an ListOutputStream object. The objects will be input in the same order that
 * they were output using a ListOutputStream.
 *
...
public class ListInputStream<E> implements Iterable<E> {
  public class ListInputStreamIterator<T> implements Iterator<T> {
    ...
    /*****************************************
     * Make sure the file is closed in case iterator is not finished
     ****************************************/
    @Override
  ...
  /****************************************************
   * Creates a new ListInputStream with the UnlabeledHashTrees populated from the file given as
   * fileName.
   *
   * @param fileName
  ...
  /****************************************************
   * Gets the tree at a specific index from the start of the file using 0 index.
   *
