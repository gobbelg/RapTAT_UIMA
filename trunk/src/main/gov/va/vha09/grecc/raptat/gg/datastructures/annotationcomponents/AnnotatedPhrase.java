...
/********************************************************
 * Stores information about a sequence of tokens that might correspond to a sequence of words in a
 * phrase or an entire sentence. Tokens are stored as both a processedTokens list and a rawTokens
 * list. "Raw" tokens are those that were not lost due to stop word removal. Note that there is no
 * guarantee that tokens in the raw token list are different from those in the processed token list
 * (i.e. they may refer to the the same token object).
 *
...
public class AnnotatedPhrase extends RaptatTokenSequence
   ...
   */
  public AnnotatedPhrase(AnnotatedPhrase annotatedPhrase) {
   ...
   * @param phraseFields
   */
  public AnnotatedPhrase(AnnotatedPhraseFields phraseFields) {
   ...
   */
  public AnnotatedPhrase(List<RaptatToken> phraseTokens, RaptatDocument documentOfOrigin,
      String annConcept, String mentionID, String annotatorName, String annotatorID, int index,
      List<RaptatAttribute> attributes, List<ConceptRelation> relations) {
  ...
  /**********************************************
   * Constructs an annotated phrase. Used by processDocument to build a sentence. It is assume that
   * the processedTokens refer to rawTokens, so, when this method sets sentenceOfOrigin, it only
   * does it for the raw tokens thus covering the processedTokens also.
   *
   * @param thePhrase
   * @param theOffsets
   * @param phraseTokens
   ...
   **********************************************/
  public AnnotatedPhrase(String thePhrase, Span theOffsets,
      RaptatPair<List<RaptatToken>, List<RaptatToken>> phraseTokens, boolean addTokensAsSentence,
      AnnotatedPhrase previousSentence, RaptatDocument documentOfOrigin,
      Set<String> sentenceConcepts, String annotatorID, String annotatorName) {
  ...
  /**********************************************
   * Constructor used by XMLImporter in the buildAnnotationTrainingList() method. Note that it does
   * not assign a value to the rawTokenNumber field.
   *
   * @param annotationData
   *
   * @author Glenn Gobbel - Feb 8, 2013
   **********************************************/
  public AnnotatedPhrase(String[] annotationData) {
   ...
   */
  public AnnotatedPhrase(String[] annotationData, List<RaptatAttribute> attributes,
  ...
  /**********************************************
   * Constructor used to create AnnotationPhrase objects with token data
   *
   * @param annotationData
   * @param phraseTokens
   *
   ...
   **********************************************/
  public AnnotatedPhrase(String[] annotationData, List<RaptatToken> phraseTokens) {
    this.mentionID = annotationData[AnnotationDataIndex.MENTION_ID.ordinal()];
    this.rawTokensStartOffset = annotationData[AnnotationDataIndex.START_OFFSET.ordinal()];
    this.rawTokensEndOffset = annotationData[AnnotationDataIndex.END_OFFSET.ordinal()];
    this.phraseStringUnprocessed = annotationData[AnnotationDataIndex.SPAN_TEXT.ordinal()];
  ...
  public void addAttribute(RaptatAttribute attr) {
    this.phraseAttributes.add(attr);
  }


  public void addSentenceAssociatedConcept(String concept) {
  ...
  public void addSentenceAssociatedConcepts(Collection<AnnotatedPhrase> conceptAnnotations) {
  ...
  @Override
  public void addSequenceAssociatedConcept(String conceptName) {
    Integer conceptOccurrences;
  ...
  /*************************************************************
   * Generates "Start" and "End" tokens to add to the sentence tokens and use in training
   *
  ...
  public List<RaptatToken> getProcessedTokensAsSentence() {
    ...
    String tokenEndOffset = String
        .valueOf(Integer.parseInt(tokenStartOffset) + Constants.SENTENCE_START_STRING.length());
    resultList.add(new RaptatToken(Constants.SENTENCE_START_STRING, Constants.SENTENCE_START_STRING,
        Constants.SENTENCE_START_STRING, Constants.SENTENCE_START_STRING,
        Constants.SENTENCE_START_STRING, tokenStartOffset, tokenEndOffset, "", false, false));
    resultList.addAll(this.processedTokens);

    tokenStartOffset = this.processedTokens.get(tokenListSize - 1).endOff;
    tokenStartOffset = String.valueOf(Integer.parseInt(tokenStartOffset) + 1);
    tokenEndOffset =
        String.valueOf(Integer.parseInt(tokenStartOffset) + Constants.SENTENCE_END_STRING.length());
    resultList.add(new RaptatToken(Constants.SENTENCE_END_STRING, Constants.SENTENCE_END_STRING,
        Constants.SENTENCE_END_STRING, Constants.SENTENCE_END_STRING, Constants.SENTENCE_END_STRING,
  ...
  public List<String> getProcessedTokensAugmentedStringsAsSentence() {
    List<String> result = new ArrayList<>(this.processedTokens.size());
    result.add(Constants.SENTENCE_START_STRING);
    for (RaptatToken curToken : this.processedTokens) {
      result.add(curToken.getTokenStringAugmented());
    }
    result.add(Constants.SENTENCE_END_STRING);
  ...
  public boolean hasAttributeAndValue(String attributeName, String attributeValue) {
    for (RaptatAttribute attribute : this.phraseAttributes) {
  ...
  public void setAnnotatorID(String id) {
    this.annotatorID = id;
   ...
   * @return list of relations
   */
  public void setConceptRelations(List<ConceptRelation> relations) {
    if (relations != null) {
      this.conceptRelations = relations;
    } else {
      this.conceptRelations = new ArrayList<>();
   ...
   */
  public void setDictionaryBasedPhrase(boolean dictionaryBasedPhrase) {
  ...
  public void setMentionId(String id) {
    this.mentionID = id;
   ...
   */
  public void setNextPhrase(AnnotatedPhrase nextPhrase) {
   ...
   */
  public void setNextSentence(AnnotatedPhrase nextSentence) {
    this.nextSentence = nextSentence;
  }


  public void setPhraseAttributes(List<RaptatAttribute> attributes) {
    if (attributes != null) {
      Collections.sort(attributes);
      this.phraseAttributes = attributes;
    } else {
  ...
  public void setPhraseStringUnprocessed(String phrase) {
   ...
   */
  public void setPreviousSentence(AnnotatedPhrase previousSentence) {
    this.previousSentence = previousSentence;
  }
  ...
  public void setPrevPhrase(AnnotatedPhrase prevPhrase) {
   ...
   */
  public void setProcessedEndOffset(String processedEndOffset) {
   ...
   */
  public void setProcessedStartOffset(String processedStartOffset) {
    this.processedTokensStartOffset = processedStartOffset;
  }


  public void setProcessedTokens(List<RaptatToken> newTokens) {
  ...
  public void setRawEndOff(String offset) {
    this.rawTokensEndOffset = offset;

  }


  public void setRawStartOff(String offset) {
    this.rawTokensStartOffset = offset;

  }


  public void setRawTokenNumber(int numberOfTokens) {
   ...
   */
  public void setRawTokens(List<RaptatToken> rawTokens) {
  ...
  public static void linkAnnotationsToSentences(HashSet<AnnotatedPhrase> resultSet) {
  ...
  public static boolean rawOffsetsOverlap(AnnotatedPhrase baseAnnotation,
      AnnotatedPhrase replacementAnnotation) {
    /*
     * Not yet implemented. Must be replaced from GirotraABI project on VINCI
     */
    GeneralHelper
        .errorWriter("Not yet implemented. Must be replaced from GirotraABI project on VINCI");
    System.exit(-1);
    return false;
  }
