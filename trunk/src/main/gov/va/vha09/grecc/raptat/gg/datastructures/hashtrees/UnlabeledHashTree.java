...
/************************************************************
 * UnlabeledHashTree - Stores number of times a sequence of tokens occurred in a document but was
...
public class UnlabeledHashTree extends HashTree<UnlabeledHashTree>
  ...
  public class UnlabeledIterator implements Iterator<HashTreeFields> {
    ...
    /****************************************************************
     * Returns the next sequence of string tokens in the hashTree that form an unlabeled token
     * sequence
     *
  ...
  public UnlabeledHashTree(UnlabeledHashTree copiedTree) {
    ...
    while (theIterator.hasNext()) {
      ...
      String[] theSequence = curFields.stringSequence.toArray(new String[0]);
  ...
  /*************************************************************
   * Add the sequence of tokens within the list starting at curTokenPosition up to the length of the
   * list or maxTokens, whichever comes first. Mark each token as unlabeled except the one at
   * skipPosition within the list. If skipPosition is less than 0, we do not skip any and call
   * another function so we don't have to keep checking this. Preconditions: None. Postconditions:
   * The tokens in the sequence are added to this instance of an UnlabeledHashTree.
   *
  ...
  /****************************************************************
   * Increment the unlabeled occurrences for each token in a token sequence
   *
  ...
  /*************************************************************
   * Add the sequence of tokens within the list starting at curTokenPosition up to the length of the
   * list or MAX_ELEMENTS_DEFAULT, whichever comes first. Only mark those at startIndex or greater
   * as unlabeled.
   *
  ...
  /*************************************************************
   * Returns the number of unlabeled occurrences of a sequence of tokens provided as a list of
   * strings being unlabeled in the document corresponding to the instantiated UnlabeledHashTree
   *
  ...
  public boolean merge(UnlabeledHashTree newTree) {
    ...
    while (theSequences.hasNext()) {
      ...
      List<String> tokenSequence = curSequenceFields.stringSequence;
  ...
  /*************************************************************
   * Add the sequence of token stems within the list starting at curTokenPosition up to the length
   * of the list or MAX_ELEMENTS_DEFAULT, whichever comes first. Mark each token as unlabeled.
   * Preconditions: None. Postconditions: The tokens in the sequence are added to this instance of
   * an UnlabeledHashTree.
   *
   * @param sentenceTokens
   * @param curTokenPosition
   * @param useStems
