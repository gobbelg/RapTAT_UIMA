...
public class CVParameterObject {
  ...
  private Map<String, List<String>> getContextSifterFields(String contextDescriptor,
    ...
    /*
     * Determine where the ContextSifter fields used for instantiation are in the contextDescriptor
  ...
  private Set<SentenceContextAttributeAnalyzer> getSentenceContextAttributeAnalyzers(
    ...
    HashMap<String, Integer> analyzerFields =
        this.getNormalizedEnumConstants(Constants.SENTENCE_CONTEXT_ATTRIBUTE_ANALYZER_FIELDS.class);
