...
public class ScorePerformanceWindow extends BaseClassWindows {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if (ScorePerformanceWindow.this.comboBoxScoringMode.getSelectedItem().toString()
        ...
        ScorePerformanceWindow.this.scoringMode =
            Constants.ScoringMode.CONCEPT_AND_ATTRIBUTE_SCORING;
      } else if (ScorePerformanceWindow.this.comboBoxScoringMode.getSelectedItem().toString()
          .equals("Concept Only")) {
        ScorePerformanceWindow.this.scoringMode = Constants.ScoringMode.CONCEPT_ONLY_SCORING;
      } else if (ScorePerformanceWindow.this.comboBoxScoringMode.getSelectedItem().toString()
          .equals("")) {
        ScorePerformanceWindow.this.scoringMode = Constants.ScoringMode.ATTRIBUTE_ONLY;
      }
  ...
  private Constants.ScoringMode scoringMode;
