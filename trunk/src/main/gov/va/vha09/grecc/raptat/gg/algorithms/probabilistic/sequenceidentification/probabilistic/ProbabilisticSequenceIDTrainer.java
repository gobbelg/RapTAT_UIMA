...
/*********************************************************
 * Class uses a datastructure known as a LabeledHashTree to store the likelihood that a given
 * sequence will be annotated. This class is responsible for building the LabeledHashTree for a set
 * of documents.
 *
...
public class ProbabilisticSequenceIDTrainer extends SequenceIDTrainer {
  ...
  protected LabeledHashTree primaryLabeledTree =
      new LabeledHashTree(Constants.LABELED_HASH_TREE_SIZE_DEPTH_0_DEFAULT, 0);
  ...
  /**********************************************
   * Constructor for ProbabilisticSequenceIDTrainer in which the smoothing method determines the
   * type of LabeledHashTree to use for training and also what tokens are considered "unlabeled."
   *
  ...
  /*************************************************************
   * Create an unlabledHashTree for the current document, which will contain all unlabeled phrases
  ...
  /*************************************************************
   * Method added to comply with SequenceIDTrainer interface
   *
   * @return
   *
  ...
  /*************************************************************
   * Method used to update an existing training solution. It is called by a SolutionUpdateProcessor
   * instance.
   *
   * @param inputGroup
  ...
  public void updateTraining(AnnotationGroup curGroup) {
    ...
    if (ProbabilisticSequenceIDTrainer.LOGGER.isDebugEnabled()) {
      for (UnlabeledHashTree curTree : (UnlabeledHashTreeStreamer) this.unlabeledHashTreeOutstream) {
        System.out.print("Document:" + curGroup.getRaptatDocument().getTextSourceName());
        /*
         * 6/21/20 - commented out code for running Siew/Matheny AKI project
         */
  ...
  /*************************************************************
   * Add how many times a phrase within a list of phrases occurs in an UnlabeledHashTree and add
   * this number to the unlabeled field of the primary tree for the sequence.
   *
   * Precondition: None.
   *
  ...
  /*************************************************************
   * Determine how many times a token sequence within a list of token sequences has occurred in a
   * set of unlabeledHashTrees and add that number to the primaryHashTree.
   *
  ...
  /*************************************************************
   * Get the phrases that were annotated by RapTAT but not by the human annotator. A phrase is
   * considered annotated by both if there is overlap by at least one token (i.e. the start and end
   * offsets of a token from the RapTAT phrase is within the start and end offsets of the human
   * annotated phrase).
   *
