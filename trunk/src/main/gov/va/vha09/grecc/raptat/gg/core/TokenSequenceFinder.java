...
public abstract class TokenSequenceFinder {
  ...
  protected HashSet<String> outputConcepts;
  ...
  protected List<AnnotatedPhrase> convertToAnnotations(
    ...
    if (invertTokenSequence) {
      for (RaptatPair<List<RaptatToken>, String> phraseAndConcept : phrasesAndConcepts) {
        ...
        annotationData[AnnotationDataIndex.MENTION_ID.ordinal()] = idGenerator.getUnique();
        ...
        annotationData[AnnotationDataIndex.SPAN_TEXT.ordinal()] =
            RaptatToken.getUnprocessedStringFromTokens(tokenSequence);
