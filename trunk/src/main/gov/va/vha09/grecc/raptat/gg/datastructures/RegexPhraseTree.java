...
public class RegexPhraseTree extends PatriciaTrie<Mark> {
   ...
   *
   */
  private static final long serialVersionUID = -5806940480601749891L;
  /**
  ...
  public void addPhrases(List<String[]> thePhrases, Mark marker) {
    for (String[] curPhrase : thePhrases) {
      String curPhraseString = String.join(" ", curPhrase);
      Generex generex = new Generex(curPhraseString);
  ...
  public static void main(String[] args) {
    ...
    rpt.maxGeneratedStrings = 2000;
    ArrayList<String[]> regexList = new ArrayList<String[]>();
    regexList.add(new String[] {"a\\.? \\/? (a|b)(\\.)"});
    rpt.addPhrases(regexList, null);
  }
}
