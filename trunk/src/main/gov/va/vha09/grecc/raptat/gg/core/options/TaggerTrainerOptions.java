...
public class TaggerTrainerOptions {
  ...
  private int wordConjunctionSize = Constants.WORD_CONJUNCTION_SIZE_DEFAULT;

  private int wordOffsetDistance = Constants.WORD_OFFSET_DISTANCE_DEFAULT;

  private int posConjunctionSize = Constants.POS_CONJUNCTION_SIZE_DEFAULT;

  private int posOffsetDistance = Constants.POS_OFFSET_DISTANCE_DEFAULT;

  private int cueOffsetFeatureMax = Constants.CUE_OFFSET_DISTANCE_FEATURE_MAX;
