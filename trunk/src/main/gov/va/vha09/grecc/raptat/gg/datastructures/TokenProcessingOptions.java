...
/********************************************************
 * Convenience class to make it easy to pass a group of training options between object instances.
 * This class specifically stores the settings for the tokens used in training or evaluation.
 *
