...
/************************************************************
 * ConceptMatchScorer - Extends a Hashtable<String,int[]> data structure. Keeps track of matches
...
public class ConceptMatchScorer extends Hashtable<PerformanceScoreObject, int[]> {
  ...
  /***************************************************
   * getPerformanceValues - Dec 13, 2011 Return precision, recall, and f-measure as a double[] based
   * on current settings of true positives, false positives, and false negatives associated with
   * theKey
   *
   * @param theKey
  ...
  /***************************************************
   * update - Dec 13, 2011 Updates the number of true positives, false positives and true negatives
  ...
  public void update(List<String[]> theResults, int expectedConceptIndex, int resultConceptIndex) {
    ...
    for (String[] curResult : theResults) {
      ...
      if (resultConcept.equals(expectedConcept)) {
        ...
        if (!resultConcept.equalsIgnoreCase(Constants.NULL_ELEMENT)) {
