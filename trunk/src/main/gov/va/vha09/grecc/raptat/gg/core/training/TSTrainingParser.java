...
public class TSTrainingParser {
   ...
   */
  private final static String TRAINING_DATA_FILEPATH_SHORTOPT = "r";
  private final static String TRAINING_DATA_FILEPATH_LONGOPT = "trainingDataFilePath";
   ...
   * annotated.
   */
  private final static String SCHEMA_FILEPATH_SHORTOPT = "s";
  private final static String SCHEMA_FILEPATH_LONGOPT = "schemaFilePath";
   ...
   */
  private final static String ANNOTATION_APP_SHORTOPT = "a";
  private final static String ANNOTATION_APP_LONGOPT = "annotationApp";
   ...
   */
  private final static String TRAINING_CONCEPTS_FILEPATH_SHORTOPT = "c";
  private final static String TRAINING_CONCEPTS_FILEPATH_LONGOPT = "trainingConceptsFilePath";
   ...
   */
  private final static String DICTIONARY_FILEPATH_SHORTOPT = "d";
  private final static String DICTIONARY_FILEPATH_LONGOPT = "dictionaryFilePath";

  /*
   * SENTENCE_FILTER filters all the text sentences and uses only those that match the specified
   * sentence filter for training.
   */
  private final static String SENTENCE_FILTER_SHORTOPT = "i";
  private final static String SENTENCE_FILTER_LONGOPT = "sentenceFilters";
   ...
   */
  private final static String ATTRIBUTE_TAGGER_PATHS_SHORTOPT = "b";
  private final static String ATTRIBUTE_TAGGER_PATHS_LONGOPT = "attributeTaggers";
   ...
   */
  private final static String ATTRIBUTE_CONFLICT_MANAGERS_SHORTOPT = "g";
  private final static String ATTRIBUTE_CONFLICT_MANAGERS_LONGOPT = "attributeConflictManagers";
   ...
   */
  private final static String TOKEN_SEQUENCE_FINDER_METHOD_SHORTOPT = "m";
  private final static String TOKEN_SEQUENCE_FINDER_METHOD_LONGOPT = "tokenSequenceFinderMethod";
   ...
   */
  private final static String SECTION_MATCH_TEXT_SHORTOPT = "v";
  private final static String SECTION_MATCH_TEXT_LONGOPT = "sectionMatchText";
  private final static String SECTION_MATCH_FILE_SHORTOPT = "w";
  private final static String SECTION_MATCH_FILE_LONGOPT = "sectionMatchFilePath";
   ...
   */
  private final static String SENTENCE_MATCH_TEXT_SHORTOPT = "y";
  private final static String SENTENCE_MATCH_TEXT_LONGOPT = "sentenceMatchText";
  private final static String SENTENCE_MATCH_FILE_SHORTOPT = "z";
  private final static String SENTENCE_MATCH_FILE_LONGOPT = "sentenceMatchFilePath";
   ...
   */
  private final static String SENTENCE_CONTEXT_ANALYZER_TEXT_SHORTOPT = "k";
  private final static String SENTENCE_CONTEXT_ANALYZER_TEXT_LONGOPT =
      "sentenceContextAnalyzerText";
  private final static String SENTENCE_CONTEXT_ANALYZER_FILE_SHORTOPT = "n";
  private final static String SENTENCE_CONTEXT_ANALYZER_FILE_LONGOPT =
   ...
   */
  private final static String CONTEXT_SIFTER_TEXT_SHORTOPT = "e";
  private final static String CONTEXT_SIFTER_TEXT_LONGOPT = "contextSifterText";
  private final static String CONTEXT_SIFTER_FILE_SHORTOPT = "f";
  private final static String CONTEXT_SIFTER_FILE_LONGOPT = "contextSifterFilePath";
   ...
   */
  private final static String ANNOTATION_GROUP_POSTPROCESSOR_SHORTOPT = "t";
  private final static String ANNOTATION_GROUP_POSTPROCESSOR_LONGOPT =
      "annotationPostProcessorDescriptors";

  private final static String INVERT_TOKEN_SEQUENCE_LONGOPT = "invertTokenSequence";
  private final static String USE_STEMS_LONGOPT = "useStems";
  private final static String USE_POS_LONGOPT = "usePOS";
  private final static String REMOVE_STOP_WORDS_LONGOPT = "removeStopWords";
  private final static String TRAINING_TOKEN_NUMBER_LONGOPT = "trainingTokenNumber";
   ...
   */
  private final static String TOKEN_SEQUENCE_SMOOTHING_METHOD_LONGOPT =
      "tokenSequenceSmoothingMethod";

  private final static String HELP_SHORTOPT = "h";
  private final static String HELP_LONGOPT = "help";

  /*
   * This option allows properties to be loaded from a file rather than on the command line
   */
  private final static String PROPERTIES_PARSE_SHORTOPT = "p";
  private final static String PROPERTIES_PARSE_LONGOPT = "propertiesFile";
  ...
  public TSTrainingParser() {
    ...
    Option conceptsFilePath = Option.builder(TSTrainingParser.TRAINING_CONCEPTS_FILEPATH_SHORTOPT)
        .required(false).hasArg(true).longOpt(TSTrainingParser.TRAINING_CONCEPTS_FILEPATH_LONGOPT)
  ...
  public TSTrainingParameterObject parseCommandLine(String[] args) {
    ...
    try {
      ...
      if (cmd.hasOption(TSTrainingParser.TRAINING_CONCEPTS_FILEPATH_SHORTOPT)
          || cmd.hasOption(TSTrainingParser.TRAINING_CONCEPTS_FILEPATH_LONGOPT)) {
        trainingConceptsFilePath =
            cmd.getOptionValue(TSTrainingParser.TRAINING_CONCEPTS_FILEPATH_SHORTOPT);
      }
    ...
    return new TSTrainingParameterObject(trainingDataFilePath, schemaFilePath, annotationApp,
        trainingConceptsFilePath, dictionaryFilePath, sentenceFilters, attributeTaggerPaths,
