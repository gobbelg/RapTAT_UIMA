...
/************************************************************
 * MatchesTable - Keeps track of matches (true positives, false positives, false negatives) with
 * respect to any key (such as a given concept or number of potential concepts)
 *
...
public class MatchTable extends Hashtable<String, int[]> {
  ...
  /****************************************************************
   * Set the number of correct matches, incorrect matches, and unmatched phrases associated with the
   * given key
   *
   * @param theKey
