...
/************************************************************
 * OccProbTriplet - Object to hold an int and two doubles in a single object. Used to store the
...
public class OccurProbTriplet implements Serializable {
  ...
  /*****************************************************************
   * Construct an OccurProbTriplet from an integer and two doubles
   *
