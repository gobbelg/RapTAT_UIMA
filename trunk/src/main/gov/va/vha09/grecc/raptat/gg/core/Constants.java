...
/************************************************************
 * Holds global constants used for setting the initial size of the hash tables used to store
 * concepts,word/concept pairs, words, and concepts associated with words
 *
...
public abstract class Constants {
  ...
  public enum AnnotationDataIndex {
    MENTION_ID, START_OFFSET, END_OFFSET, SPAN_TEXT, ANNOTATOR_NAME, CREATION_DATE, CONCEPT_NAME;
  }
  ...
  public enum SENTENCE_CONTEXT_ATTRIBUTE_ANALYZER_FIELDS {
    ATTRIBUTE_NAME, SENTENCE_CONTEXT_NAME, DEFAULT_ATTRIBUTE_VALUE, CONTEXT_ASSIGNED_ATTRIBUTE_VALUE, RETURN_DEFAULT
  }
  ...
  public final static int BOW_SEQUENCE_ID_PRIOR_INDEX = 0;

  public final static int BOW_SEQUENCE_ID_PHRASE_INDEX = 1;

  public final static int BOW_SEQUENCE_ID_POST_INDEX = 2;

  public final static int BOW_SEQUENCE_ID_ANNOTATED_INDEX = 0;

  public final static int BOW_SEQUENCE_ID_NOT_ANNOTATED_INDEX = 1;
  ...
  public final static int NEGATION_WINDOW_SIZE_DEFAULT = 6;

  public final static int UNCERTAIN_WINDOW_SIZE_DEFAULT = 10;

  public final static int REASON_NO_MEDS_WINDOW_SIZE_DEFAULT = 20;
   ...
   */
  public final static String CRF_FIELD_DELIMITER_DEFAULT = "_D_L@M#T_";

  public final static String CRF_ASSERTION_CUE_MARKER = "_N_C@U#E_";

  public final static int DEFAULT_BUFFERED_STREAM_SIZE = 524288;

  public final static String DEFAULT_SOLUTION_DIRECTORY = "/raptat/solutionFiles";
  ...
  public static final String FILTER_START = Constants.FILTER_STRINGS[1];
  ...
  public static final String CONCEPT_MAPPING_METHOD_DEFAULT = Constants.CONCEPT_MAPPING_METHODS[1];
  ...
  public static final String PROPERTY_TEXT_COLUMN = "textColumn";

  public static final String POPERTY_UNIQUE_ID_COLUMN = "documentUniqueIdColumn";
  ...
  public static final boolean DIRECT_DATABASE_WRITE = true;

  public static final String SCHEMA_FILE_PATH =
      "D:\\KarunaWorkspace\\RapTAT\\ExamplesForKaruna\\ExamplesForKaruna\\SchemaFile.xml";

  public static final String DB_CONFIG_FILE_PATH =
      "./resources/config/properties/databaseConfig.properties";
