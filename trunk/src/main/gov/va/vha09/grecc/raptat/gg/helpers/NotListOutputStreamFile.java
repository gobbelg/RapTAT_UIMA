...
/*********************************************************
 * Thrown during construction of an ListInputStream to indicate that it is trying to open a file
 * that was not written by an ListOutputStream, which is the only file type that an
 * InterableInputStream instance should read
 *
