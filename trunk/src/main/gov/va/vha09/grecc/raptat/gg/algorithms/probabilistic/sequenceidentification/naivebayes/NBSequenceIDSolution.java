...
public class NBSequenceIDSolution {
  ...
  public NBSequenceIDSolution(int maxTokens) {
    ...
    for (int i = 0; i < maxTokens; i++) {
      this.vocabSize[i] = 0;
      this.conditionals[i] = new AnnotationConditionalTable(Constants.NB_UNIQUE_TOKEN_TABLE_SIZE);
      ...
      this.modifiedElements[i] = new StrPairSet(Constants.NB_UNIQUE_TOKEN_CONCEPT_PAIRS);
    }

    this.priors = new NBPriorTable(Constants.NB_CONCEPT_TABLE_SIZE, maxTokens);
