...
/***********************************************************
 * Holds unique pairs of objects in a set. Uses a hashtable with the value of each key (which is an
 * attribute-concept pair) being a dummy value of "true". Used to store items so that every pair
 * occurs only once in the list. Note that this could be done with a HashSet, but the Hashtable is
 * synchronized unlike HashSet.
 *
...
public class StrPairSet extends HashSet<StrPair> {
  ...
  /*****************************************************************
   * Construct a new StrPairSet with size startCapacity
   *
  ...
  /****************************************************************
   * Convert two strings to a pair and store them in the set
   *
   * @param firstString
   * @param secondString
   ****************************************************************/
