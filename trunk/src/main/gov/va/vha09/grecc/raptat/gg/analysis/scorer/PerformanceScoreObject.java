...
public class PerformanceScoreObject {
  public final static PerformanceScoreObject EXACT_MATCH_PSO =
      new PerformanceScoreObject(Constants.TOTAL_EXACT_MATCH_NAME);
  public static final PerformanceScoreObject PARTIAL_MATCH_PSO =
   ...
   */
  public PerformanceScoreObject(String conceptName, String attributeName, String attributeValueName,
      String relationshipName, String conceptLinkedToByRelationship,
      String relationshipAttributeName, String relationshipAttributeValueName) {
    super();
    if (conceptName == null) {
      conceptName = "";
    }
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!this.relationshipAttributeValueName.equals(other.relationshipAttributeValueName)) {
      return false;
    }
  ...
  public int hashCode() {
    ...
    result =
        prime * result + (this.attributeValueName == null ? 0 : this.attributeValueName.hashCode());
    ...
    result = prime * result
        + (this.relationshipAttributeName == null ? 0 : this.relationshipAttributeName.hashCode());
