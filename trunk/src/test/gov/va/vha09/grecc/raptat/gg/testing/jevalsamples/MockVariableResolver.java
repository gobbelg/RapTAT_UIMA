...
/**
 * This clas is an example of a custom variable resolver that can set onto an instance of an
 * evaluator.
 */
public class MockVariableResolver implements VariableResolver {
   ...
   *
   * @return A variable value for the specified variable name. If the variable name can not be
   *         resolved, then null should be returned.
   * 
