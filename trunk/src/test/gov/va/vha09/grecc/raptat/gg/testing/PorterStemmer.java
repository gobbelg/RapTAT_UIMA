...
public class PorterStemmer {
  ...
  public static void main(String[] args) {
    ...
    String[] words = {"medical", "infarctions", "necessities", "ischemic"};

    for (String curWord : words) {
      System.out.println(curWord + ":" + ps.stemToken(curWord));
    }
    // char[] w = new char[501];
  ...
  public String stemToken(String inToken) {
    char[] c = inToken.toCharArray();
    this.add(c, c.length);
    this.stem();
