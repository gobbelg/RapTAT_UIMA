...
/**
 * This class is an example of a custom function that executes within Evaluator. The function
 * returns the source string in reverse order.
 */
public class MockStringReverseFunction implements Function {
   ...
   * @param arguments A string argument that will be converted into a string that is in reverse
   *        order. The string argument(s) HAS to be enclosed in quotes. White space that is not
   *        enclosed within quotes will be trimmed. Quote characters in the first and last positions
   *        of any string argument (after being trimmed) will be removed also. The quote characters
   *        used must be the same as the quote characters used by the current instance of Evaluator.
  ...
  public FunctionResult execute(Evaluator evaluator, String arguments) throws FunctionException {
    ...
    try {
      ...
      String argumentOne =
          FunctionHelper.trimAndRemoveQuoteChars(stringValue, evaluator.getQuoteCharacter());
