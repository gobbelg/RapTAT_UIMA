...
/**
 * Contains a couple of samples for evaluating expression containing variables. There are many more
...
public class VariablesSample {
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      /**
       * This sample clears the variables. This call will not clear preloaded variables.
       */
